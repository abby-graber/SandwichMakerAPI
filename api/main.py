...
def update_one_order(recipe_id: int, recipe: schemas.SandwichUpdate, db: Session = Depends(get_db)):
...
def read_one_order(resource_id: int, db: Session = Depends(get_db)):
...
def update_one_order(resource_id: int, resource: schemas.ResourceUpdate, db: Session = Depends(get_db)):
...
def create_order(order_detail: schemas.ResourceCreate, db: Session = Depends(get_db)):
...
def read_one_order(order_detail_id: int, db: Session = Depends(get_db)):
...
def update_one_order(order_detail_id: int, order_detail: schemas.OrderDetailUpdate, db: Session = Depends(get_db)):
